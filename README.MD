...
To create a stand-alone environment named `Project 3` with Python 3 and all the required package versions, run the following:

```bash
$ conda env create -n Project 3 -f environment.yml
```
